...
function love.load()
	...
	winningFont = love.graphics.newFont('font.ttf', 22)
	
	love.window.setTitle('Pong v1.1')
...
function love.draw()
	...
	elseif gameState == 'serve' then
		love.graphics.printf('Player : ' ..tostring(servingPlayer) ..' serving ! ', 0, 10, VIRTUAL_WIDTH, 'center')
	elseif gameState == 'play' then
		love.graphics.printf('Match in Progress!', 0, 20, VIRTUAL_WIDTH, 'center')
	else
		love.graphics.setFont(winningFont)
		love.graphics.printf('Winner is : ' ..winningPlayer, 0, 10, VIRTUAL_WIDTH, 'center')
		love.graphics.setFont(smallFont)
